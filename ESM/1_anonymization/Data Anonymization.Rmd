...
single_valued_columns <- sapply(daily, function(col) length(unique(col)) == 1)
cat("Variables with only one unique value:\n", names(daily[single_valued_columns]))
```
...
daily %>% select(au_pg, au_dg, au_bib, au_fib, cub1, cub2, cub3, cub4, cub5, cub6,
             ...
             er2_o, er3_o, er4_o, ssb2, er1_s, er2_s, er3_s, er4_s, dub5, dub6) %>% map(tabyl)
